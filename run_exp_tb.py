...
if __name__ == "__main__":
    ...
    # for seed in range(3):
    #     args.seed = seed
    #     for num_rollouts in [200]:
    #         args.num_rollouts = num_rollouts
    #         args.num_target_rollouts = int(num_rollouts//10)
    #         for batch_size in [32, 256]:
    #             args.batch_size = batch_size
    #             for transition_network in ["medium", "deep"]:
    #                 args.transition_network = transition_network
    #                 if batch_size == 32 and transition_network == "medium":
    #                     continue
    #                 run_name = train(args)
